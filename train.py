...
from utils.dataloader_mask31 import UnetDataset, unet_dataset_collate
from utils.utils import download_weights, show_config
from utils.utils_fit_mask31 import fit_one_epoch
...
if __name__ == "__main__":
    ...
    data_path = './Data/truehard/'
    image_path = '/Data/allimg/'
    model_path = ''
    loss_fuc = "Diceloss"
    ...
    print("##########################################"+backbone+"#######################################################")
    model = MHMoE_Net(img_size=448,in_chans=3,embed_dim=96,num_classes=num_classes).cuda()



    time_str = datetime.datetime.strftime(datetime.datetime.now(), '%Y_%m_%d_%H_%M')
    save_dir = os.path.join(save_dir, "ModelLabel_train_public_"+time_str)
